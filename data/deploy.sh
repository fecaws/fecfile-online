...
sleep 20
NEWPOD=$(kubectl --context=arn:aws:eks:us-east-1:813218302951:cluster/fecfile --namespace=$3 get pods --selector=job-name=fecfile-flyway-db-job --output=jsonpath={.items..metadata.name})
