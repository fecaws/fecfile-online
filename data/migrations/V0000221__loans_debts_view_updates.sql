UPDATE dynamic_form_fields SET seperator=true where transaction_type = 'COEXP_PARTY_DEBT' AND field_db_name in ('memo_text','purpose');

UPDATE dynamic_form_fields SET seperator=false where transaction_type = 'COEXP_PARTY_DEBT' AND field_db_name='payee_cmte_id';
