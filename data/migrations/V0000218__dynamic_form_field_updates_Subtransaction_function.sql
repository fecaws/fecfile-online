...
UPDATE public.dynamic_form_fields SET entity_group = 'ind-group' WHERE field_db_name in ('last_name', 'first_name', 'middle_name', 'prefix', 'suffix') and transaction_type in 
