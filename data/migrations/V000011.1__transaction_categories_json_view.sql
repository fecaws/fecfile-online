...
SELECT form_type,json_build_object('transaction-categories',json_transaction_type,
                         ...
                         'transaction-search-field',(select json_build_object('text','transaction-search','type','text','placeholder','Search for transaction'))
