ALTER TABLE public.ref_entity_types
    ADD CONSTRAINT ref_entity_type_pk PRIMARY KEY (entity_type);

update ref_entity_types set entity_type_description='Individual' where entity_type='IND';
update ref_entity_types set entity_type_description='Organization' where entity_type='ORG';



drop view transaction_category_json_view;
