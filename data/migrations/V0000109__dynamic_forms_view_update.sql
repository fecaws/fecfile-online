...
ALTER TABLE public.dynamic_form_fields ALTER COLUMN class_name TYPE character varying(60) ;
alter table dynamic_form_fields add column child_form boolean default false;
alter table dynamic_form_fields add column form_sub_title character varying(200);    
...
CREATE OR REPLACE VIEW public.dynamic_forms_view AS
 WITH dy_forms_by_section AS (
         SELECT dynamic_form_fields.form_type,
          ...
          WHERE dynamic_form_fields.field_type::text <> 'hidden'::text and transaction_type='EAR_REC'
