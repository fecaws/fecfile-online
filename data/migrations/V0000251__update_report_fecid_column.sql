...
ALTER TABLE public.reports ALTER COLUMN fec_id TYPE character varying(15);
...
UNION
 SELECT to_number(forms_committeeinfo.id, '9G999D99') AS report_id,
...
ALTER TABLE public.reports_view
    OWNER TO postgres;

GRANT ALL ON TABLE public.reports_view TO postgres;
