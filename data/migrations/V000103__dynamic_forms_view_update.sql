...
ALTER TABLE public.dynamic_form_fields
    RENAME transaction_type_identifier TO transaction_type_desc;

ALTER TABLE public.dynamic_form_fields
    ALTER COLUMN transaction_type_desc TYPE character varying(300) ;
...
CREATE OR REPLACE VIEW public.dynamic_forms_view AS
 WITH dy_forms_by_section AS (
         SELECT dynamic_form_fields.form_type,            
          ...
          GROUP BY dynamic_form_fields.form_type, dynamic_form_fields.transaction_type, dynamic_form_fields.field_section, dynamic_form_fields.field_section_order, dynamic_form_fields.class_name, dynamic_form_fields.seperator, dynamic_form_fields.transaction_type
        )
