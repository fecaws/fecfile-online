...
alter table public.sched_h4 add column aggregation_ind character varying(1);
alter table public.sched_h6 add column aggregation_ind character varying(1);
