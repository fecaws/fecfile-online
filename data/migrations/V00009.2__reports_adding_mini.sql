...
select
      ...
      cvg_end_date,
      due_date,
      replace(rc.form_type,'F','') as form_type_mini
...
select cm.cmte_id,rc.category,ccd.due_date,rf.form_description,rf.form_info,rf.form_pdf_url,rc.form_type,replace(rc.form_type,'F','') as form_type_mini
from
...
update public.due_dates set report_year=extract( YEAR from cvg_end_date);
