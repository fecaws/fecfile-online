update sched_a set transaction_type_identifier='INDV_REC' where transaction_type ='15';
...
CREATE OR REPLACE VIEW public.all_transactions_view AS 
 SELECT sa.cmte_id,
    ...
    sa.last_update_date,
        CASE
            WHEN ((sa.aggregate_amt < 200::numeric) AND (sa.memo_code <> 'X' OR sa.memo_code is  NULL)) THEN 'U'::text
